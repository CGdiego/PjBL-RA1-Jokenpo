...
> ⚠️ Os efeitos sonoros com `winsound` funcionam **apenas no Windows**. Então caso esteja utilizando outro sistema operacional, use a versão `winsoundless` na pasta `extra`.
